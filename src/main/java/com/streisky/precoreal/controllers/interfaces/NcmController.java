...
public interface NcmController {
    ...
    @ApiResponse(responseCode = "400", description = "Nome do produto ausente ou em branco")
    @ApiResponse(responseCode = "500", description = "Falha na comunicação com o provedor de IA")
    NcmResponseDto findNcm(
            @NotBlank @Parameter(description = "Nome do produto a ser classificado", example = "Notebook Dell Inspiron") @RequestParam String productName);
}
